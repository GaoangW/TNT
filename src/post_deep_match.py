...
max_time_dist = 28
cost_thresh = 14 #8.7
min_cost_thresh = 9.3 #6.1
x_dist_thresh = 250
y_dist_thresh = 250
angle_cost_thresh = 40
motion_cost_thresh = 5
img_size = [1920,1080]
...
while 1:
    ...
    while 1:
        ...
        #import pdb; pdb.set_trace()
        if min_v<min_cost_thresh and temp_angle_cost<angle_cost_thresh and temp_motion_cost<motion_cost_thresh:
